...
pdf(paste("RNAseq_RibosomeProfiling", "QC_sample_distance_matrix_CDS.pdf", sep = "_"))
...
pdf(paste("RNAseq_RibosomeProfiling", "QC_count_matrix_CDS.pdf", sep = "_"))
...
pdf(paste("RNAseq_RibosomeProfiling", "QC_PCA_CDS.pdf", sep = "_"))
...
res_2_vs_1$gene_symbol <- convertIDs(row.names(res_2_vs_1), "ENSEMBL", "SYMBOL", org.Rn.eg.db)
...
write.table (res_2_vs_1_df,
             file = paste("RNAseq_RibosomeProfiling", "DESeq2_res.csv", sep = "_"),
             sep = ",",
             row.names = F,
             col.names = T,
             quote = F)
...
pdf(paste("RNAseq_RibosomeProfiling", "Volcano_plot.pdf", sep = "_"), width = 4, height = 5)
